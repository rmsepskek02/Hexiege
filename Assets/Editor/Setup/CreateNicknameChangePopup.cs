...
namespace Hexiege.EditorTools
{
    ...
    public static class CreateNicknameChangePopup
    {
        ...
        public static void Run()
        {
            ...
            SetLayoutElement(paidNoticeGo, 62f, 0f);
            ...
            SetLayoutElement(purchaseGo, 64f, 0f);
            ...
            SetLayoutElement(statusGo, 34f, 0f);

            // ButtonRow(확인 + 취소)
            GameObject buttonRow = FindOrCreateChild(panel.transform, "ButtonRow");
            EnsureHLG(buttonRow, 14f);
            SetLayoutElement(buttonRow, 76f, 0f);
            ...
            SetLayoutElement(confirmGo, 76f, 0f);
            confirmGo.GetComponent<LayoutElement>().flexibleWidth = 1f;
            ...
            SetLayoutElement(cancelGo, 76f, 0f);
            cancelGo.GetComponent<LayoutElement>().flexibleWidth = 1f;
