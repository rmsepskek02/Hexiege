...
namespace Hexiege.EditorTools
{
    ...
    public static class CreateRankingTable
    {
        ...
        public static void Run()
        {
            ...
            SetAnchors(table.GetComponent<RectTransform>(), new Vector2(0.035f, 0.075f), new Vector2(0.965f, 0.985f));
            ...
            tableVlg.spacing = 6f;
            tableVlg.padding = new RectOffset(10, 10, 10, 10);
            ...
            SetLayoutPreferredHeight(headerRow, 58f);
            for (int i = 0; i < ColumnLabels.Length; i++)
            {
                ...
                EnsureButton(colGo, boldFont, ColumnLabels[i], new Color(0.18f, 0.22f, 0.30f, 1f), 24);
            ...
            SetLayoutFlexibleHeight(scrollGo, 1f);    // 남는 영역 전체 사용
            ...
            SetLayoutPreferredHeight(pageRow, 64f);

            GameObject prevGo = FindOrCreateChild(pageRow.transform, "PrevButton");
            prevGo.transform.SetSiblingIndex(0);
            Button prevButton = EnsureButton(prevGo, boldFont, "이전", new Color(0.30f, 0.34f, 0.42f, 1f), 24);
            ...
            TextMeshProUGUI pageText =
                EnsureText(pageTextGo, lightFont, "1 / 1", 25, TextAlignmentOptions.Center);
            ...
            TextMeshProUGUI emptyStateText = EnsureText(
                emptyGo, lightFont, "아직 랭킹이 없습니다 (20판 이상 필요)", 26, TextAlignmentOptions.Center);
        ...
        private static void SetLayoutPreferredHeight(GameObject go, float preferredHeight)
        {
            if (!go.TryGetComponent(out LayoutElement le))
                le = go.AddComponent<LayoutElement>();
