...
| 돌격소총병 (Assault) | 40 | 1 | 2.0 | 2.0 | 1 | 0.2 | 10초 | 100 | 1 | |
| 저격총병 (Sniper) | 30 | 18 | 5.0 | 5.0 | 0.25 | 3.0 | 20초 | 200 | 1 | |
| 근접기사 (LittleKnight) | 35 | 4 | 0.5 | 1.0 | 1 | 0:25, 1:15(3:00) | 5초 | 50 | 1 | 2히트 공격 |
| 창병 (SpearMan) | 50 | 10 | 1.0 | 1.5 | 1 | 0:24(2:00) | 10초 | 100 | 1 | |
| 도끼병 (BattleAxe) | - | - | - | - | - | 1:02 (3:05) | - | - | - | |
| 전차 (Tank) | 100 | 30 | 3.0 | 4.0 | 1 | 4.0 | 30초 | 400 | 1 | 건물에 2배 대미지 |
| 포격수레 (CannonCart) | 50 | 20 | 3.0 | 4.0 | 1 | 4.0 | 20초 | 150 | 1 | 건물에 2배 대미지 |
...
| InfernoSpirit | 60 | 25 | 4.0 | 4.0 | 1 | 1:15(3:00) | 30초 | 400 | 1 | |
| DustSpirit | 50 | 6 | 0.5 | 1.0 | 0.5 | 1:04(3:00) | 5초 | 50 | 1 | |
| BoulderSpirit | 80 | 8 | 0.5 | 1.0 | 0.5 | 1:15(4:00) | 15초 | 100 | 1 | |
| QuakeSpirit | - | - | - | - | - | 1:20(5:00) | - | - | - | |
| TideSpirit | 30 | 7 | 0.5 | 1.0 | 1 | 1:15(3:00) | 5초 | 50 | 1 | |
| StreamSpirit | 30 | 6 | 3.0 | 3.0 | 0.5 | 0:17(1:15) | 10초 | 100 | 1 | |
| TorrentSpirit | - | - | - | - | - |  (4:00) | - | - | - | 파도를 보내어 대미지 파도가 대미지를 주는 형태 |

## 유닛 — 초월계 (Transcendence)

| 유닛 | HP | 공격력 | 공격 사거리 (타일) | 감지 사거리 (타일) | 이동속도 (칸/초) | 공격 쿨다운 (초) | 생산 시간 | 골드 비용 | 인구 | 비고 |
|------|----|--------|--------------------|--------------------|------------------|------------------|-----------|-----------|------|------|
| FoxMagician | 20 | 15 | 3.0 | 3.0 | 0.5 | 2:25(4:00) | 5 | 70 | 1 | |
| BearGuard | 100 | 6 | 0.5 | 1.0 | 1 | 0:20(1:20) | 25초 | 300 | 1 | |
...
| RabbitTrickster | 20 | 10 | 0.5 | 1.0 | 2 | 0:18(2:00) | 5초 | 50 | 1 | |
| MushroomBomber | - | - | - | - | - | 1:00(3:00) | - | - | - | 포자를 던지고 주변에 독을 퍼뜨려 지속대미지를 주는 형태 |
| BloomFairy | - | - | - | - | - | 1:00(3:00) | - | - | - | 대미지가 아닌 아군 유닛 하나 지정하여 힐링 |
