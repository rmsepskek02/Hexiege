...
> ⏳ **무작위 맵 구현 시 배치 후보 판정을 일반 건설 조건으로 전환한다. (2026-09-03 기준 미전환 — 3단계 몫)** 현재 코드는 후보를 **이동 가능 여부**로 고르고 있으며, **전환 전까지는 그것이 맞다.**
...
> 판정하며, 「일반 건설」 전용 조건으로 옮기는 것은 무작위 맵 3단계 몫이다. 광산 타일 조회(이 절)와 배치 후보 판정(규칙 26)은
