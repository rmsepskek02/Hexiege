...
- `[SerializeField] private ConfirmPopup _confirmPopup;` 제거 (이미 완료)
...
| 파일 | 필드 | 변경 내용 |
|--|--|--|
| `InGameSettingsUI.cs` | `[SerializeField] private ConfirmPopup _confirmPopup` | 필드 제거, `UIManager.Instance?.ShowConfirm(...)` 호출로 교체 |
