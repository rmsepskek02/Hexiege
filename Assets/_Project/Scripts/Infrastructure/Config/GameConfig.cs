...
namespace Hexiege.Infrastructure
{
    ...
    public class GameConfig : ScriptableObject
    {
        ...
        /// <summary>
        /// 건물 스프라이트 Y축 오프셋 (월드 단위).
        /// 타일 중심보다 위에 배치하여 타일 위에 건물이 서있는 느낌을 줌.
        /// </summary>
        ...
        // ====================================================================
        // 혼잡도 기반 경로 분산 설정
        // 유닛이 지나간 타일에 혼잡도가 쌓이고, 다음 유닛은 혼잡한 타일을
        // 더 비싼 경로로 인식해 자연스럽게 분산 이동하게 한다.
        // ====================================================================

        [Header("Congestion Spread")]

        /// <summary>
        /// 혼잡도가 1 감소하는 간격(초).
        /// 작을수록 혼잡도가 빠르게 사라져 분산 효과가 약해지고,
        /// 클수록 오래 유지되어 분산 효과가 강해진다.
        /// </summary>
        [Tooltip("혼잡도가 1 감소하는 간격(초). 작을수록 빠르게 사라짐.")]
        public float CongestionDecayInterval = 5f;

        /// <summary>
        /// 혼잡도 1당 A* 경로 비용에 추가되는 가중치.
        /// 클수록 혼잡한 타일을 더 강하게 회피해 분산 효과가 강해진다.
        /// </summary>
